...
_path_inject(['/Users/dinku/Documents/01-My Docs/02-Code/01-Python/proper/Own/PyAppTest'])
...
DEFAULT_SCRIPT='/Users/dinku/Documents/01-My Docs/02-Code/01-Python/proper/Own/PyAppTest/Hand_tracker.py'
SCRIPT_MAP={}
try:
    _run()
